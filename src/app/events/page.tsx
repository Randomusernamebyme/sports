      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-primary-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-primary-600">解開謎題</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <div className="flex-1">
              <input
                ...
                className="w-full px-4 py-2 border border-primary-200 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filteredEvents.map((event) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-primary-900">{event.name}</h3>
                  <p className="mt-2 text-primary-600">{event.description}</p>
                  <div className="mt-4 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-sm text-primary-600">{event.rating}</span>
                    </div>
                    <span className="text-sm text-primary-500">{event.participants} 人參與</span>
                  </div>
                  <div className="mt-4 flex items-center justify-between text-sm text-primary-500">
                    <div className="flex items-center">
